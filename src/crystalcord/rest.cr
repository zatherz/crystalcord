...
module CrystalCord
  module REST
    ...
    USER_AGENT  = "DiscordBot (https://github.com/zatherz/crystalcord, #{CrystalCord::VERSION})"
    ...
    def get_gateway
      ...
      Basic::REST::GatewayResponse.from_json(response.body)
    end
    ...
    def get_channel(channel_id : UInt64)
      ...
      Basic::Channel.from_json(response.body)
    end
    ...
    def get_channel_messages(channel_id : UInt64, limit : UInt8 = 50, before : UInt64? = nil, after : UInt64? = nil, around : UInt64? = nil)
      ...
      Array(Basic::Message).from_json(response.body)
    end
    ...
    def get_channel_message(channel_id : UInt64, message_id : UInt64)
      ...
      Basic::Message.from_json(response.body)
    end
    ...
    def get_channel_invites(channel_id : UInt64)
      ...
      Array(Basic::InviteMetadata).from_json(response.body)
    end
    ...
    def create_channel_invite(channel_id : UInt64, max_age : UInt32 = 0,
      ...
      Basic::Invite.from_json(response.body)
    end
    ...
    def get_guild(guild_id : UInt64)
      ...
      Basic::Guild.from_json(response.body)
    end
    ...
    def get_guild_channels(guild_id : UInt64)
      ...
      Array(Basic::Channel).from_json(response.body)
    end
    ...
    def get_guild_member(guild_id : UInt64, user_id : UInt64)
      ...
      Basic::GuildMember.from_json(response.body)
    end
    ...
    def list_guild_members(guild_id : UInt64, limit : UInt8 = 1, after : UInt64 = 0)
      ...
      Array(Basic::GuildMember).from_json(response.body)
    end
    ...
    def get_guild_bans(guild_id : UInt64)
      ...
      Array(Basic::User).from_json(response.body)
    end
    ...
    def get_guild_roles(guild_id : UInt64)
      ...
      Array(Basic::Role).from_json(response.body)
    end
    ...
    def create_guild_role(guild_id : UInt64)
      ...
      Basic::Role.from_json(response.body)
    end
    ...
    def get_guild_voice_regions(guild_id : UInt64)
      ...
      Array(Basic::VoiceRegion).from_json(response.body)
    end
    ...
    def get_guild_integrations(guild_id : UInt64)
      ...
      Array(Basic::Integration).from_json(response.body)
    end
    ...
    def get_guild_embed(guild_id : UInt64)
      ...
      Basic::GuildEmbed.from_json(response.body)
    end
    ...
    def get_user(user_id : UInt64)
      ...
      Basic::User.from_json(response.body)
    end
    ...
    def get_current_user_guilds
      ...
      Array(Basic::UserGuild).from_json(response.body)
    end
    ...
    def get_user_dms
      ...
      Array(Basic::PrivateChannel).from_json(response.body)
    end
    ...
    def create_dm(recipient_id : UInt64)
      ...
      Basic::PrivateChannel.from_json(response.body)
    end
    ...
    def get_users_connections
      ...
      Array(Basic::Connection).from_json(response.body)
    end
